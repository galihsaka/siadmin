...
<div class="container-fluid">
    ...
    <?php if (strtolower($hakAkses) == 'mahasiswa') { ?>
        <!-- Content Mahasiswa -->
        <div class="row" id="Mahasiswa" style="margin-top:100px">
            <div class="col-md-6">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a rel="nofollow" href="<?php echo base_url('observasi/Studilapangan/daftar_studilapangan') ?> ">
                            <button class="btn btn-primary form-control">Ajukan Izin Studi Lapangan</button>
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Surat Izin Penelitian</h6>
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                        ...
                        <a target="_blank" rel="nofollow" href="https://undraw.co/">
                            <button class="btn btn-primary form-control">Ajukan Izin Penelitian</button>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <h4 class="small font-weight-bold">Pembuatan Menu <span class="float-right">40%</span></h4>
                        <div class="progress mb-4">
                            <div class="progress-bar bg-warning" role="progressbar" style="width: 40%"
                                 aria-valuenow="40"
                                 aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h4 class="small font-weight-bold">Database Setup <span class="float-right">0%</span></h4>
                        <div class="progress mb-4">
                            <div class="progress-bar bg-warning" role="progressbar" style="width: 0%" aria-valuenow="0"
                                 aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h4 class="small font-weight-bold">Generate Document <span class="float-right">20%</span></h4>
                        <div class="progress mb-4">
                            <div class="progress-bar bg-danger" role="progressbar" style="width: 20%" aria-valuenow="20"
                                 aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                        <h4 class="small font-weight-bold">Progress Planning <span class="float-right">100%</span></h4>
                        <div class="progress mb-4">
