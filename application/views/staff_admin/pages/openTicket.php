            ...
            <!-- /col-lg-12 -->
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data">
                     <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <select name="id_sistem" id="id_sistem" class="form-control" data-validation="required" autofocus required>
                                <option value="">-- Pilih --</option>
                                <option value="1">Praktik Industri</option>
                                <option value="2">Skripsi dan Tugas Akhir</option>
...
<script>
    $(document).ready(function(){
        $('#id_sistem').change(function(){
            ...
            // AJAX request
            $.ajax({
                url: '<?= base_url('ticket/getKategori'); ?>',
                method: 'post',
                ...
                success: function(response){
                    ...
                    $.each(response,function(index,data){
                        $('#kategori').append('<option value="'+data['id']+'">'+data['nama_kategori_ticket']+'</option>');
                    });
                }
            });
        });
