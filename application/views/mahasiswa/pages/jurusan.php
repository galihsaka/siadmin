    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div id="buttonContainer" style="padding-bottom: 20px">
                ...
                <!-- BUTTON TAMBAH DATA -->
                <a href="<?= base_url('mhs/penelitian_jurusan/daftar') ?>"
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="dataLapangan" width="100%" cellspacing="0">
                    ...
                    foreach ($data as $row) {
						...
						$buat = $row->tgl_buat;
                        $tanggal_buat = tgl_indo($buat); //UBAH FORMAT tanggal_buat
                        $id = $row->ID;
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- TOMBOL CETAK -->
                                <a href="<?php if($stat=='Berhasil'){echo base_url('mhs/penelitian_jurusan/printdoc/' . $row_enc.'/'.$stat);} ?>"<?php if($stat=="Berhasil"){echo " target='_blank'" ;}?><?php if($stat=='Gagal'){echo " data-toggle='modal' data-target='#printjurusan$id'";
                                $url="mhs/penelitian_jurusan/printdoc/" . $row_enc."/".$stat;}?> class='btn btn-primary btn-icon-split btn-sm'>
                                    <span class='icon text-white-50'>
                                        <i class='fas fa-print'></i>
                                    </span>
                                    <span class='text'>Cetak</span>
                                </a>
								<div class="modal fade" id="printjurusan<?php echo $id?>" tabindex="-1" role="dialog"
